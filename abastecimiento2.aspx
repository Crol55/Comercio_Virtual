<%@ Page Language="C#" AutoEventWireup="true" CodeFile="abastecimiento2.aspx.cs" Inherits="abastecimiento2" %>
      ...
      <ul>
        <li class="active"><a href="comercios.aspx">Sesion iniciada</a></li>
              <li><a href="#">Consultas</a>
                   <ul>
            <li><a href="pedidos.aspx">Pedidos Del Comercio</a></li>
...
<div class="wrapper col1">
    ...
    <table class="auto-style1">
        <tr>
            <td>
                <asp:Label ID="Label9" runat="server" Text="Consultar Prioridad por"></asp:Label>
