<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sesionclientes.aspx.cs" Inherits="sesionclientes" %>
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="#">Modificar</a>
            <ul>
            <li><a href="modificarclientes.aspx">modificar Datos personales</a></li>
...
<div class="wrapper col11">
    <br /> <br /> <br /> 
   <h1 id="eti">BIENVENIDO A SU CUENTA DE USUARIOS</h1>
   <h2 id="eti2">Modifique datos o compre produtos en linea</h2>
</div>
