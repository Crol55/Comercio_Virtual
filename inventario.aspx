...
<div class="wrapper col12">
    ...
    <table class="auto-style1">
        <tr>
            <td colspan="2">
                <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="White" Text="Inventario General"></asp:Label>
&nbsp;</td>
            <td colspan="2">
                <asp:Label ID="Label2" runat="server" Font-Size="Medium" ForeColor="White" Text="Inventario por Comercio"></asp:Label>
            </td>
        </tr>
        <tr>
