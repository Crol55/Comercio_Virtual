  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="catalogo.aspx">catalogos</a></li>
        <li><a href="#">Cerrar</a>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:Label ID="Label4" runat="server" ForeColor="White" Text="Usuario" Font-Size="Medium"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style3">
                <asp:Label ID="Label2" runat="server" ForeColor="White" Text="Correo" Font-Size="Medium"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtcorreo" runat="server" Width="151px" OnTextChanged="txtcorreo_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
            ...
            <td>
                <asp:TextBox ID="txtcontrasena" runat="server" Width="152px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
