<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cargarxml.aspx.cs" Inherits="cargarxml" %>
    ...
    <table class="auto-style1">
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="White" Text="Busque sus archivos  con el boton de Seleccionar Archivo"></asp:Label>
            </td>
